    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!(pass_et.getText().toString().equals("")||email_et.getText().toString().equals(""))) {
                    ...
                    Toast.makeText(getApplicationContext(),"Please Enter both Email and Password fields",Toast.LENGTH_LONG).show();
                }
            }
        });
